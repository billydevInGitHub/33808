...
public class RuntimeJobRepository {
    ...
    public boolean setRTJobState(RT_Job_Info rt_job_info, String newState) {
	...
	public RT_Job_Info updateRTJobInfo(RT_Job_Info rtJobInfo) {
	  	  jdbcTemplate.update(
				  "update rt_job_info set "
				  + "state=? "
//				  + "job_name=?,"
//				  + "application_name=?,"
//				  + "appl_generation_number=?,"
//				  + "start_time=?,"
//				  + "end_time=?,"
//				  + "agent_name=?,"
//				  + "script=?,"
...
//				  + " return_code=? "
				  + " where job_id=?", 
				  rtJobInfo.getState(), 
//				  rtJobInfo.getJob_name(),
//				  rtJobInfo.getApplication_name(),
//				  rtJobInfo.getAppl_generation_number(),
//				  rtJobInfo.getStartTime(),
//				  rtJobInfo.getEndTime(),
//				  rtJobInfo.getAgent_name(),
//				  rtJobInfo.getScript(),
//				  rtJobInfo.getArguments_of_script(),
//				  rtJobInfo.getUser_id(),
//				  rtJobInfo.getReturnCode(),
				  rtJobInfo.getJob_id()); 
