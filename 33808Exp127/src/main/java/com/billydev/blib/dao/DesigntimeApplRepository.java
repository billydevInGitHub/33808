...
@Repository
public class DesigntimeApplRepository {
...
//                    	dtJobInfo.setSuccessors(successors);                    	  
    ...
    public ArrayList<DT_Appl_Info> listAllDesignTimeAppls(){
    	...
    	String sql="select * from dt_appl_info";
    	ArrayList<DT_Appl_Info> arrayListDTAppls= new ArrayList<>(); 
        ...
        jdbcTemplate.query(
        	    ...
        	    new RowCallbackHandler(){  
                    ...
                    public void processRow(ResultSet rs) throws SQLException { 
                    	...
                    	arrayListDTAppls.add(dt_appl_info);
                    }
        		});
    	
    	return arrayListDTAppls; 
    }
