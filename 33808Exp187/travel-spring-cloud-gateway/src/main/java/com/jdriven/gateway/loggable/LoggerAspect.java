package com.jdriven.gateway.loggable;
...
//    @Around("execution(* org.springframework.security.oauth2.client.endpoint.AbstractWebClientReactiveOAuth2AccessTokenResponseClient.getTokenResponse(..))")
    @Around("execution(* org.springframework.security.authentication.DelegatingReactiveAuthenticationManager.authenticate(..))")
//    @Around("execution(* org.springframework.web.server.handler.ExceptionHandlingWebHandler.handle(..))")
