package com.billydev.blib.test;
...
import com.billydev.blib.b33808.exp006.BillySessionApplication;

public class BillySessionApplicationTest {
	...
	private ConfigurableApplicationContext createContext() {
		ConfigurableApplicationContext context = new SpringApplicationBuilder()
				.sources(BillySessionApplication.class)
